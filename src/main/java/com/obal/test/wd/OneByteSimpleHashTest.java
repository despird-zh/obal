...
public class OneByteSimpleHashTest {
  ...
  public void testMaxDistribution() {
    HashPrefixDistributor.OneByteSimpleHash hasher = new HashPrefixDistributor.OneByteSimpleHash(256);
  ...
  public void testLimitedDistribution() {
    HashPrefixDistributor.OneByteSimpleHash hasher = new HashPrefixDistributor.OneByteSimpleHash(10);
    byte[][] allPrefixes = hasher.getAllPossiblePrefixes();
  ...
  private void testDistribution(int maxBuckets, int countForEachBucket) {
    HashPrefixDistributor distributor = new HashPrefixDistributor(new HashPrefixDistributor.OneByteSimpleHash(maxBuckets));
